...
// Used by AuthenticatedUser::from_request; dead_code fires because no handler
// currently uses AuthenticatedUser as an extractor (handlers use X-User-Id header).
#[allow(dead_code)]
